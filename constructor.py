...
f.write(f'n = %s     \n' %(n))
f.write(f'Xs_m1 = %s(F, np.linspace(0, tmax, 1000), x0, h, args)[0] \n'   %(m1))
f.write(f'xs_m1 = %s(F, np.linspace(0, tmax, 1000), x0, h, args)[0][0] \n' %(m1))
f.write(f'ys_m1 = %s(F, np.linspace(0, tmax, 1000), x0, h, args)[0][1] \n' %(m1))
f.write(f'zs_m1 = %s(F, np.linspace(0, tmax, 1000), x0, h, args)[0][2] \n' %(m1))
f.write(f'Xs_m2 = %s(F, np.linspace(0, tmax, 1000), x0, h, args)[0] \n'    %(m2))
f.write(f'xs_m2 = %s(F, np.linspace(0, tmax, 1000), x0, h, args)[0][0] \n' %(m2))
f.write(f'ys_m2 = %s(F, np.linspace(0, tmax, 1000), x0, h, args)[0][1] \n' %(m2))
f.write(f'zs_m2 = %s(F, np.linspace(0, tmax, 1000), x0, h, args)[0][2] \n' %(m2))
f.write(f'Xs_m3 = modn(F, np.linspace(0, tmax, 1000), x0, h, n, %sstep, %sstep, args)[0]    \n' %(m1, m2))
f.write(f'xs_m3 = modn(F, np.linspace(0, tmax, 1000), x0, h, n, %sstep, %sstep, args)[0][0] \n' %(m1, m2))
f.write(f'ys_m3 = modn(F, np.linspace(0, tmax, 1000), x0, h, n, %sstep, %sstep, args)[0][1] \n' %(m1, m2))
f.write(f'zs_m3 = modn(F, np.linspace(0, tmax, 1000), x0, h, n, %sstep, %sstep, args)[0][2] \n' %(m1, m2))
...
f.write('line_ani = animation.FuncAnimation(fig, update_lines, 1000, fargs=(data, lines, ax),interval=50, blit=False) \n')
